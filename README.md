...
- _A `relational database` is the database system used for querying and managing storage while `SQL` is the language used to query `relational databases`_

2. Why do tables need a `primary key`?

- _Tables have primary keys to uniquely identify each row and record in the database_
